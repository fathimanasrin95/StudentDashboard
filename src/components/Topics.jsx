...
const Topics = () => {
  ...
  <Typography align='center' marginBottom={15} gutterBottom variant="h3" component="div">
    ...
    <Card sx={{ width:{xs:300,sm:300,md:450,lg:550,xl:600},height:350 }}>
     ...
     <Link to={"/fullstack"} > <Button style={{backgroundColor:'#00a6bb'}} size="small" color="primary" variant='contained'>
          View
        </Button></Link>
    </Card>
    </Grid>
    ...
    <Card sx={{ width:{xs:300,sm:300,md:450,lg:550,xl:600},height:350}}>
      ...
      <CardContent>
       ...
       <Link to={'/machine'}> <Button style={{backgroundColor:'#00a6bb'}} size="small" color="primary" variant='contained'>
          View
        </Button></Link> 
    </Card>
    </Grid>
    ...
    <Card sx={{ width:{xs:300,sm:300,md:450,lg:550,xl:600},height:350}}>
      ...
      <CardContent>
       ...
       <Link to={"/cyber"}>  <Button style={{backgroundColor:'#00a6bb'}} size="small" color="primary" variant='contained'>
          View
        </Button></Link>
    </Card>
    </Grid>
    ...
    <Card sx={{  width:{xs:300,sm:300,md:450,lg:550,xl:600},height:350}}>
      ...
      <CardContent>
       ...
       DevOps with Azure Projects
        ...
        <Link to={"/devops"}> <Button style={{backgroundColor:'#00a6bb'}} size="small" color="primary" variant='contained'>
          View
        </Button></Link>
    </Card>
    </Grid>
